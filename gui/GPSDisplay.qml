    ...
    Column {id: coordsDisplay
        ...
        Item {
            ...
            Row {
                ...
                Text {id: onOffLabel; text: "GPS:" ; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthShort}
        ...
        Row {
            spacing: coordsDisplay.rowSpacing;
            Text {id: latiLabel; text: "Lati:" ; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthShort}
        ...
        Row {
            spacing: coordsDisplay.rowSpacing;
            Text {id: lngiLabel; text: "Long:" ; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthShort}
        ...
        Row {
            spacing: coordsDisplay.rowSpacing;
            Text {id: altiLabel; text: "Alti:"; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthShort}
        ...
        Row {
            spacing: coordsDisplay.rowSpacing;
            Text {id: speedLabel; text: "Speed:"; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthShort}
        ...
        Row {
            spacing: coordsDisplay.rowSpacing;
            Text {id: horizAccLabel; text: "Horizontal Accuracy:"; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthLong}
        ...
        Row {
            spacing: coordsDisplay.rowSpacing;
            Text {id: vertAccLabel; text: "Vertical Accuracy:" ; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthLong}
        ...
        Row {
            spacing: coordsDisplay.rowSpacing;
            Text {id: satsInViewUseLabel; text: "Sats in View / Use:" ; font.family: "Arial"; font.pixelSize: LandedTheme.FontSizeMedium; color: thisGPSDisplay.labelColor; width: LandedTheme.LabelWidthLong}
        ...
        Item {
            ...
            Row {
                ...
                spacing: 10
                anchors.verticalCenter: parent.verticalCenter
                Text {id: compassTextLabel; font.pixelSize: LandedTheme.FontSizeMedium; color: compassOn ? thisGPSDisplay.labelColorActive : thisGPSDisplay.labelColorInactive; text: "Bearing:"; width: LandedTheme.LabelWidthShort}
